export default {
  ...
  imageOverlay: "Image",
  imageOverlays: "Images superposées",
  noImageOverlays: "Aucune image n'a été ajoutée",
  addImageOverlay: "Ajouter une image",
  opacity: "Opacité",
  rotation: "Rotation",
  size: "Taille",
  searchMemes: "Rechercher des mèmes...",
  noMemesFound: "Aucun mème trouvé",
  errors: {
